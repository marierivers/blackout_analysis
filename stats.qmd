...
- percent of population age 18 and younger
- percent of households below the poverty level

Of the significant variables, black; hispanic / latino; age 18 and younger; and poverty were positively correlated with residential power outages. Significant variables that were negatively correlated with residential power outages included white and age 65 and older.
...
model_summary_df <- data.frame(model_name = c("white", "black", "native american", "asian", "hispanic / latino", "65 and older", "18 and younger", "poverty", "median income"),
